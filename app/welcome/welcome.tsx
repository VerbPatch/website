export function Welcome() {
  return (
    <main className="h-dvh flex items-center justify-center">
      <div className="main-box  border-2 rounded-xl h-[250px] w-[400px] relative">
        Welcome to Verbpatch, home of headless libraries
        <div className="main-box-icons absolute bottom-0 stroke-[#a4a4a4]">
